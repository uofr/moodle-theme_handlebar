...
$page = new admin_settingpage('theme_handlebar_presets', get_string('presets_settings', 'theme_handlebar'));
...
$fs = get_file_storage();
$files = $fs->get_area_files($context->id, 'theme_handlebar', 'preset', 0, 'itemid, filepath, filename', false);
...
$name = 'theme_handlebar/presetfiles';
$title = get_string('presetfiles', 'theme_handlebar');
$description = get_string('presetfiles_desc', 'theme_handlebar');
